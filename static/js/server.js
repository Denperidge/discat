...
function saveServerSettings() {
    ...
    saveServerSettingsRequest.setRequestHeader("csrf-token", document.getElementById("csrf-token").content);
...
function addModule(moduleName) {
    ...
    addModuleRequest.setRequestHeader("csrf-token", document.getElementById("csrf-token").content);
...
function removeModule(moduleName) {
    ...
    removeModuleRequest.setRequestHeader("csrf-token", document.getElementById("csrf-token").content);
...
function saveAutoGeneratedModuleSettings() {
    ...
    saveModuleSettingsRequest.setRequestHeader("csrf-token", document.getElementById("csrf-token").content);
